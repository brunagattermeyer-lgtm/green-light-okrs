  ...
  return (
    <div className="min-h-screen bg-okr-bg">
      <div className="max-w-[900px] mx-auto px-4 sm:px-6 py-8">
        ...
        <h1 className="text-xl font-semibold text-okr-dk mb-2">Gestão de Pessoas</h1>
        <p className="text-sm text-okr-mi">Conteúdo da área de gestão de pessoas em desenvolvimento.</p>
      </div>
    </div>
  );
};
